...
const Contact: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <motion.section 
        className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-24"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      General: info@gearupsports.com<br />
                      Support: support@gearupsports.com
                    </p>
                  </div>
                </motion.div>
            ...
            {[
              {
                ...
                answer: "We offer a 30-day return policy for all unused items in original packaging. Returns are free for orders over $99."
              },
              {
              ...
              },
              {
                ...
                answer: "Yes, most products come with manufacturer warranties. Premium items include our extended warranty program."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
